...
#ifndef WRISTCOACH_SWIFT_H
#define WRISTCOACH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WristCoach",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10WristCoach17ExtensionDelegate")
...
SWIFT_CLASS("_TtC10WristCoach33HealthKitWorkoutSessionController")
@interface HealthKitWorkoutSessionController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
